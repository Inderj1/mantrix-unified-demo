      ...
      <Box sx={{ flex: 1, overflow: 'auto' }}>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          {[
            ...
            { label: 'Product Line', value: selectedAlert.productLine, color: '#3b82f6', icon: <StoreIcon /> },
              ...
              <CardContent sx={{ p: 2, flex: 1 }}>
                ...
                <Stack spacing={1}>
                  {selectedAlert.relatedProducts.slice(0, 4).map((product, idx) => (
                    <Box key={idx} sx={{ p: 1.5, borderRadius: 1, bgcolor: alpha('#3b82f6', 0.05), border: '1px solid', borderColor: alpha('#3b82f6', 0.15) }}>
