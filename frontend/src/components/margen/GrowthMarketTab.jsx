    ...
    { field: 'brand', headerName: 'Brand', minWidth: 180, flex: 1 },
    {
      ...
      renderCell: (params) => (
        <Chip
          ...
          sx={{
            fontWeight: 600,
            bgcolor: params.value === 'RTD Tea' ? alpha('#10b981', 0.12) : params.value === 'Energy' ? alpha('#f97316', 0.12) : alpha('#3b82f6', 0.12),
            color: params.value === 'RTD Tea' ? '#059669' : params.value === 'Energy' ? '#ea580c' : '#2563eb',
          }}
        />
      ),
    },
    ...
    return (
      <Box sx={{ flex: 1, overflow: 'auto' }}>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          {[
            { label: 'Market Share', value: `${selectedRow.marketShare.toFixed(1)}%`, color: '#3b82f6', icon: <TrophyIcon /> },
                ...
                <Box sx={{ height: 200 }}>
                  <Line
                    data={{
                      ...
                      datasets: [
                        { label: 'Revenue ($M)', data: selectedRow.monthlyTrend.map(t => t.revenue), borderColor: '#3b82f6', yAxisID: 'y' },
                  ...
                  <Doughnut
                    data={{
                      ...
                      datasets: [{
                        ...
                        backgroundColor: [alpha('#3b82f6', 0.8), alpha('#10b981', 0.8), alpha('#f59e0b', 0.8), alpha('#8b5cf6', 0.8), alpha('#ef4444', 0.8)],
                      }],
                    }}
                    options={{
                      responsive: true,
            ...
            <Grid item xs={6} sm={3}>
              <Card sx={{ background: 'linear-gradient(135deg, #eff6ff 0%, #ffffff 100%)' }}>
                <CardContent sx={{ py: 2 }}>
                  ...
                  <Typography variant="h4" sx={{ fontWeight: 700, color: '#2563eb' }}>{kpis?.totalMarketShare.toFixed(1)}%</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={6} sm={3}>
