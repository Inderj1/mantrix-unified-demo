...
/**
 * Standardized O2C.AI Theme Configuration
 * Blue corporate palette for all DataGrid tables and components
 * Matches ORDLY.AI theme structure for consistency
 */

export const o2cTheme = {
  // Color Palette - Blue focused (same as ORDLY.AI)
  colors: {
