      ...
      <Box sx={{ p: 3, minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: darkMode ? '#0d1117' : '#f8fafc', overflow: 'auto' }}>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 1 }}>
            <ScheduleIcon sx={{ fontSize: 40, color: '#0854a0' }} />
            <Box>
        ...
        <Card variant="outlined" sx={{ mb: 3 }}>
          <CardContent sx={{ py: 1.5, display: 'flex', gap: 4, flexWrap: 'wrap' }}>
            ...
            <Box
              ...
              sx={{ cursor: 'pointer', '&:hover': { bgcolor: alpha('#0854a0', 0.05), borderRadius: 1, mx: -1, px: 1 } }}
            >
            ...
            <Card variant="outlined" sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
              <Box sx={{ p: 2, borderBottom: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Stack direction="row" alignItems="center" spacing={1}>
                  <SpeedIcon sx={{ color: '#0854a0', fontSize: 18 }} />
                ...
                <Chip label="4 options" size="small" sx={{ bgcolor: alpha('#0854a0', 0.12), color: '#1565c0', fontWeight: 600, fontSize: '0.7rem' }} />
              </Box>
              ...
              <Box sx={{ p: 2, overflow: 'auto', flex: 1 }}>
                  ...
                  {leadTimeBreakdown.map((item) => (
                    <Box key={item.label} sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                      ...
                      <Box sx={{ flex: 1, height: 20, bgcolor: alpha('#64748b', 0.08), borderRadius: 1, overflow: 'hidden' }}>
                        <Box sx={{ width: `${item.percentage}%`, height: '100%', bgcolor: item.type === 'positive' ? '#10b981' : '#0854a0', borderRadius: 1 }} />
                      </Box>
                ...
                <Paper variant="outlined" sx={{ p: 2 }}>
                  ...
                  <Box sx={{ mb: 1.5 }}>
                    ...
                    <Slider size="small" value={expediteValue} min={0} max={3} onChange={(e, v) => setExpediteValue(v)} sx={{ color: '#0854a0' }} />
                  </Box>
                </Paper>
              </Box>
            </Card>
    ...
    <Box sx={{ p: 3, minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: darkMode ? '#0d1117' : '#f8fafc', overflow: 'auto' }}>
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        {[
          ...
          { label: 'Avg. Lead Time', value: stats.avgLeadTime, color: '#0854a0' },
      ...
      <Card variant="outlined" sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <Box sx={{ p: 2, borderBottom: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <LocalShippingIcon sx={{ color: '#0854a0', fontSize: 18 }} />
