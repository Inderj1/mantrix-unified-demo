...
const SupplierTermsImpact = ({ onBack, onTileClick, darkMode = false }) => {
        ...
        <Paper sx={{ mb: 2, bgcolor: colors.paper, border: `1px solid ${colors.border}` }}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ p: 2, pb: 1 }}>
            ...
            <FormControl size="small" sx={{ minWidth: 140 }}>
              ...
              <Select value={categoryFilter} label="Category" onChange={(e) => setCategoryFilter(e.target.value)} sx={{ bgcolor: colors.paper }}>
