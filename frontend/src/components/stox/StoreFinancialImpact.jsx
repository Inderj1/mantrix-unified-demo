...
const StoreFinancialImpact = ({ onBack, darkMode = false }) => {
    ...
    <Box sx={{ p: 3, height: '100vh', display: 'flex', flexDirection: 'column', bgcolor: colors.background }}>
      <Box sx={{ mb: 3 }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 2 }}>
          <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
            ...
            <Typography color="primary" variant="body1" fontWeight={600} sx={{ color: colors.primary }}>Tile 3: Financial Impact</Typography>
          </Breadcrumbs>
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Box>
            <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 1 }}>
              ...
              <Typography variant="h4" fontWeight={700} sx={{ color: colors.text }}>Tile 3: Financial Impact & Recommendation Engine</Typography>
      ...
      {metrics && (
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ bgcolor: colors.cardBg, border: `1px solid ${colors.border}`, background: `linear-gradient(135deg, ${alpha('#10b981', 0.1)} 0%, ${alpha('#10b981', 0.05)} 100%)` }}>
              <CardContent>
                <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
                  <CheckCircle sx={{ color: '#10b981' }} />
                  <Typography variant="body2" sx={{ color: colors.textSecondary }}>Approved</Typography>
                </Stack>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Card sx={{ bgcolor: colors.cardBg, border: `1px solid ${colors.border}`, background: `linear-gradient(135deg, ${alpha('#f59e0b', 0.1)} 0%, ${alpha('#f59e0b', 0.05)} 100%)` }}>
              <CardContent>
                <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
                  <TrendingUp sx={{ color: '#f59e0b' }} />
                  <Typography variant="body2" sx={{ color: colors.textSecondary }}>Avg GMROI</Typography>
                </Stack>
      ...
      <Paper sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minHeight: 0, width: '100%', bgcolor: colors.paper, border: `1px solid ${colors.border}` }}>
        <DataGrid
          ...
          sx={{
            ...
            ...(darkMode && {
              '& .MuiDataGrid-root': { color: colors.text, borderColor: colors.border },
              ...
              '& .MuiDataGrid-row': { '&:hover': { bgcolor: alpha(colors.primary, 0.08) } },
              '& .MuiDataGrid-footerContainer': { borderColor: colors.border, bgcolor: colors.cardBg },
              '& .MuiTablePagination-root': { color: colors.text },
              '& .MuiDataGrid-toolbarContainer': { color: colors.text, borderColor: colors.border },
