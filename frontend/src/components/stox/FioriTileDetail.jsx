...
const getColumnConfig = (tileId) => {
  const columnConfigs = {
    'sell-through-bridge': [
      ...
      { field: 'store_id', headerName: 'Store/Location', width: 150 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'date', headerName: 'Date', width: 120 },
      { field: 'sellThrough', headerName: 'Sell-Through', width: 120, type: 'number' },
      { field: 'sellIn', headerName: 'Sell-In (Forecast)', width: 150, type: 'number' },
      { field: 'forecast', headerName: 'AI Forecast', width: 120, type: 'number' },
      { field: 'confidence', headerName: 'Confidence %', width: 130, type: 'number' },
    ],
    'partner-pos-monitor': [
      { field: 'partner', headerName: 'Partner', width: 150 },
      { field: 'edi_feed', headerName: 'EDI Feed', width: 120 },
      { field: 'last_update', headerName: 'Last Update', width: 180 },
      { field: 'status', headerName: 'Status', width: 120, renderCell: (params) => (
        <Chip label={params.value} color={params.value === 'Active' ? 'success' : params.value === 'Delayed' ? 'warning' : 'error'} size="small" />
      )},
      { field: 'records', headerName: 'Records', width: 120, type: 'number' },
    ...
    'forecast-dashboard': [
      ...
      { field: 'date', headerName: 'Date', width: 120 },
      { field: 'actual', headerName: 'Actual', width: 100, type: 'number' },
      { field: 'forecast', headerName: 'Forecast', width: 100, type: 'number' },
      { field: 'accuracy', headerName: 'Accuracy %', width: 120, type: 'number' },
      { field: 'bias', headerName: 'Bias', width: 100, type: 'number' },
      { field: 'mape', headerName: 'MAPE %', width: 100, type: 'number' },
    ],
    'demand-analyzer': [
      { field: 'dimension', headerName: 'Dimension', width: 130 },
      { field: 'category', headerName: 'Category', width: 150 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'demand', headerName: 'Demand', width: 120, type: 'number' },
    ...
    'forecast-workbench': [
      ...
      { field: 'ai_forecast', headerName: 'AI Forecast', width: 120, type: 'number' },
      { field: 'override', headerName: 'Override', width: 120, type: 'number' },
      { field: 'promo', headerName: 'Promo', width: 100 },
      { field: 'final_forecast', headerName: 'Final Forecast', width: 140, type: 'number' },
    ...
    'demand-alerts': [
      { field: 'alert_type', headerName: 'Alert Type', width: 150 },
      { field: 'sku', headerName: 'SKU', width: 130 },
    ...
    'store-replenishment': [
      { field: 'store', headerName: 'Store', width: 130 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'forecast_7d', headerName: 'Forecast (7d)', width: 140, type: 'number' },
      { field: 'on_hand', headerName: 'On Hand', width: 120, type: 'number' },
      { field: 'in_transit', headerName: 'In Transit', width: 120, type: 'number' },
      { field: 'safety_stock', headerName: 'Safety Stock', width: 130, type: 'number' },
      { field: 'replenishment', headerName: 'Replenishment', width: 150, type: 'number', cellClassName: (params) => params.value > 0 ? 'highlight-cell' : '' },
    ],
    'route-optimizer': [
      { field: 'route', headerName: 'Route ID', width: 130 },
      { field: 'truck', headerName: 'Truck', width: 100 },
      { field: 'stores', headerName: 'Stores', width: 250 },
    ...
    'stockout-monitor': [
      { field: 'store', headerName: 'Store', width: 130 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'current_stock', headerName: 'Current Stock', width: 140, type: 'number' },
      { field: 'forecast_daily', headerName: 'Daily Forecast', width: 140, type: 'number' },
      { field: 'days_to_stockout', headerName: 'Days to Stockout', width: 160, type: 'number' },
      { field: 'risk', headerName: 'Risk', width: 120, renderCell: (params) => (
        <Chip label={params.value} color={params.value === 'Critical' ? 'error' : params.value === 'High' ? 'warning' : 'info'} size="small" />
      )},
      { field: 'action', headerName: 'Action Required', width: 200 },
    ],
    'channel-allocation': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'dc_available', headerName: 'DC Available', width: 140, type: 'number' },
      { field: 'ch01_allocation', headerName: 'CH01', width: 100, type: 'number' },
      { field: 'ch02_allocation', headerName: 'CH02', width: 100, type: 'number' },
      { field: 'ch03_allocation', headerName: 'CH03', width: 100, type: 'number' },
      { field: 'ch04_allocation', headerName: 'CH04', width: 100, type: 'number' },
      { field: 'total_demand', headerName: 'Total Demand', width: 140, type: 'number' },
    ],
    'dc-cockpit': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'on_hand', headerName: 'On Hand', width: 120, type: 'number' },
      { field: 'in_transit', headerName: 'In Transit', width: 120, type: 'number' },
      { field: 'allocated_ch01', headerName: 'Allocated CH01', width: 150, type: 'number' },
      { field: 'allocated_ch02', headerName: 'Allocated CH02', width: 150, type: 'number' },
      { field: 'safety_stock', headerName: 'Safety Stock', width: 130, type: 'number' },
      { field: 'available', headerName: 'Available', width: 120, type: 'number', cellClassName: 'highlight-cell' },
    ],
    'working-capital': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'inventory_units', headerName: 'Inventory Units', width: 150, type: 'number' },
      { field: 'unit_cost', headerName: 'Unit Cost ($)', width: 130, type: 'number' },
      { field: 'inventory_value', headerName: 'Inventory Value ($)', width: 170, type: 'number' },
      { field: 'turns', headerName: 'Turns', width: 100, type: 'number' },
      { field: 'dio', headerName: 'DIO (days)', width: 120, type: 'number' },
      { field: 'status', headerName: 'Status', width: 130, renderCell: (params) => (
    ...
    'excess-obsolete': [
      ...
      { field: 'last_sale', headerName: 'Last Sale', width: 120 },
      { field: 'days_no_sale', headerName: 'Days No Sale', width: 140, type: 'number' },
    ...
    'supply-dashboard': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'weekly_demand', headerName: 'Weekly Demand', width: 150, type: 'number' },
      { field: 'safety_stock', headerName: 'Safety Stock', width: 130, type: 'number' },
      { field: 'dc_on_hand', headerName: 'DC On Hand', width: 130, type: 'number' },
      { field: 'dc_on_order', headerName: 'DC On Order', width: 140, type: 'number' },
      { field: 'plant_supply_req', headerName: 'Plant Supply Req', width: 160, type: 'number', cellClassName: 'highlight-cell' },
    ],
    'production-optimizer': [
      { field: 'product_family', headerName: 'Product Family', width: 180 },
      { field: 'campaign_size', headerName: 'Campaign Size', width: 150, type: 'number' },
      { field: 'changeover_time', headerName: 'Changeover Time', width: 160 },
      { field: 'capacity_util', headerName: 'Capacity Util %', width: 150, type: 'number' },
      { field: 'production_days', headerName: 'Production Days', width: 160, type: 'number' },
      { field: 'efficiency', headerName: 'Efficiency %', width: 140, type: 'number' },
    ],
    'mrp-accelerator': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'planned_order', headerName: 'Planned Order', width: 150 },
      { field: 'quantity', headerName: 'Quantity', width: 120, type: 'number' },
      { field: 'mrp_date', headerName: 'MRP Date', width: 130 },
      { field: 'lead_time', headerName: 'Lead Time (days)', width: 150, type: 'number' },
    ...
    'bom-analyzer': [
      { field: 'fg_sku', headerName: 'FG SKU', width: 130 },
      { field: 'plant_req', headerName: 'Plant Req', width: 120, type: 'number' },
      { field: 'component', headerName: 'Component', width: 180 },
      { field: 'qty_per_fg', headerName: 'Qty per FG', width: 130, type: 'number' },
      { field: 'component_req', headerName: 'Component Req', width: 150, type: 'number' },
      { field: 'supplier', headerName: 'Supplier', width: 150 },
    ],
    'component-tracker': [
      { field: 'component', headerName: 'Component', width: 150 },
      { field: 'used_in', headerName: 'Used In (FGs)', width: 300 },
      { field: 'total_fgs', headerName: 'Total FGs', width: 120, type: 'number' },
      { field: 'total_demand', headerName: 'Total Demand', width: 140, type: 'number' },
      { field: 'on_hand', headerName: 'On Hand', width: 120, type: 'number' },
    ],
    'bom-exceptions': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'exception_type', headerName: 'Exception Type', width: 180 },
      { field: 'component', headerName: 'Component', width: 150 },
      { field: 'severity', headerName: 'Severity', width: 120, renderCell: (params) => (
        <Chip label={params.value} color={params.value === 'High' ? 'error' : params.value === 'Medium' ? 'warning' : 'info'} size="small" />
      )},
      { field: 'action_required', headerName: 'Action Required', width: 200 },
    ],
    'consolidation-engine': [
      { field: 'component', headerName: 'Component', width: 150 },
      { field: 'used_in', headerName: 'Used In (FGs)', width: 200 },
      { field: 'total_req', headerName: 'Total Req', width: 120, type: 'number' },
      { field: 'current_inventory', headerName: 'Current Inventory', width: 160, type: 'number' },
      { field: 'purchase_qty', headerName: 'Purchase Qty', width: 140, type: 'number', cellClassName: 'highlight-cell' },
      { field: 'supplier', headerName: 'Supplier', width: 140 },
      { field: 'savings', headerName: 'Savings', width: 120 },
    ],
    'procurement-dashboard': [
      { field: 'component', headerName: 'Component', width: 150 },
      { field: 'consolidated_po', headerName: 'Consolidated PO', width: 170 },
      { field: 'quantity', headerName: 'Quantity', width: 120, type: 'number' },
      { field: 'supplier', headerName: 'Supplier', width: 140 },
      { field: 'unit_cost', headerName: 'Unit Cost ($)', width: 130, type: 'number' },
      { field: 'total_cost', headerName: 'Total Cost ($)', width: 140, type: 'number' },
      { field: 'discount', headerName: 'Discount', width: 120 },
      { field: 'savings', headerName: 'Savings ($)', width: 130, type: 'number', cellClassName: 'highlight-cell' },
    ],
    'supplier-portal': [
      { field: 'supplier', headerName: 'Supplier', width: 150 },
      { field: 'forecast_shared', headerName: 'Forecast Shared', width: 160 },
      { field: 'last_po', headerName: 'Last PO', width: 130 },
      { field: 'next_po_est', headerName: 'Next PO Est', width: 140 },
      { field: 'delivery_performance', headerName: 'Delivery %', width: 130, type: 'number' },
      { field: 'quality_score', headerName: 'Quality Score', width: 140, type: 'number' },
    ],
    'scenario-planner': [
      { field: 'scenario', headerName: 'Scenario', width: 130 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'base_demand', headerName: 'Base Demand', width: 140, type: 'number' },
      { field: 'promo_impact', headerName: 'Promo Impact', width: 140 },
      { field: 'holiday_impact', headerName: 'Holiday Impact', width: 150 },
      { field: 'forecasted_demand', headerName: 'Forecasted Demand', width: 170, type: 'number' },
      { field: 'inventory_req', headerName: 'Inventory Req', width: 150, type: 'number' },
    ],
    'kpi-dashboard': [
      { field: 'kpi', headerName: 'KPI', width: 200 },
      { field: 'value', headerName: 'Value', width: 120, type: 'number' },
      { field: 'target', headerName: 'Target', width: 120, type: 'number' },
    ...
    'predictive-analytics': [
      { field: 'date', headerName: 'Date', width: 120 },
      { field: 'anomaly_type', headerName: 'Anomaly Type', width: 150 },
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'store', headerName: 'Store', width: 130 },
      { field: 'expected', headerName: 'Expected', width: 120, type: 'number' },
      { field: 'actual', headerName: 'Actual', width: 120, type: 'number' },
    ...
    'working-capital-optimizer': [
      { field: 'sku', headerName: 'SKU', width: 130 },
      { field: 'inventory_value', headerName: 'Inventory Value ($)', width: 170, type: 'number' },
      { field: 'target_turns', headerName: 'Target Turns', width: 140, type: 'number' },
      { field: 'current_turns', headerName: 'Current Turns', width: 150, type: 'number' },
      { field: 'dio', headerName: 'DIO', width: 100, type: 'number' },
      { field: 'target_dio', headerName: 'Target DIO', width: 130, type: 'number' },
      { field: 'cash_impact', headerName: 'Cash Impact', width: 140 },
      { field: 'status', headerName: 'Status', width: 130, renderCell: (params) => (
...
const getTileMetrics = (tileId, data) => {
  ...
  const metricConfigs = {
    'sell-through-bridge': [
      ...
      { label: 'Forecast Accuracy', value: '92%', icon: TrendingUp, color: '#3b82f6', trend: '+1.5%' },
    ...
    'partner-pos-monitor': [
      ...
      { label: 'Avg Quality', value: '96%', icon: TrendingUp, color: '#3b82f6', trend: '+3%' },
      { label: 'Error Feeds', value: data.filter(r => r.status === 'Error').length, icon: ErrorIcon, color: '#ef4444', trend: null },
      { label: 'Total Records', value: data.reduce((sum, row) => sum + (row.records || 0), 0).toLocaleString(), icon: Assignment, color: '#8b5cf6', trend: null },
    ],
    'forecast-dashboard': [
      { label: 'Avg Accuracy', value: '95%', icon: CheckCircle, color: '#10b981', trend: '+2%' },
      { label: 'Avg MAPE', value: '5.2%', icon: TrendingDown, color: '#3b82f6', trend: '-0.8%' },
      { label: 'Forecast Bias', value: '-1.2', icon: Warning, color: '#f59e0b', trend: 'Improving' },
      { label: 'Total SKUs', value: new Set(data.map(r => r.sku)).size, icon: Inventory, color: '#8b5cf6', trend: null },
    ],
    'demand-analyzer': [
      ...
      { label: 'Growth Rate', value: '+15%', icon: TrendingUp, color: '#3b82f6', trend: 'YoY' },
    ...
    'forecast-workbench': [
      ...
      { label: 'With Promo', value: data.filter(r => r.promo === 'Y').length, icon: TrendingUp, color: '#8b5cf6', trend: null },
    ],
    'demand-alerts': [
    ...
    'store-replenishment': [
      ...
      { label: 'In Transit', value: data.reduce((sum, row) => sum + (row.in_transit || 0), 0).toLocaleString(), icon: LocalShipping, color: '#3b82f6', trend: null },
    ...
    'route-optimizer': [
      ...
      { label: 'Total Distance', value: data.reduce((sum, row) => sum + parseInt(row.distance), 0) + ' mi', icon: ShowChart, color: '#3b82f6', trend: null },
    ...
    'stockout-monitor': [
      ...
      { label: 'Avg Days to Stockout', value: Math.round(data.reduce((sum, row) => sum + (row.days_to_stockout || 0), 0) / data.length) + ' days', icon: ShowChart, color: '#3b82f6', trend: null },
      { label: 'Total SKUs at Risk', value: data.length, icon: Inventory, color: '#8b5cf6', trend: null },
    ],
    'channel-allocation': [
    ...
    'dc-cockpit': [
      ...
      { label: 'Available ATP', value: data.reduce((sum, row) => sum + (row.available || 0), 0).toLocaleString(), icon: CheckCircle, color: '#3b82f6', trend: '+5%' },
    ...
    'working-capital': [
      ...
      { label: 'Avg DIO', value: Math.round(data.reduce((sum, row) => sum + (row.dio || 0), 0) / data.length) + ' days', icon: ShowChart, color: '#3b82f6', trend: '-4 days' },
    ...
    'supply-dashboard': [
      ...
      { label: 'Weekly Demand', value: data.reduce((sum, row) => sum + (row.weekly_demand || 0), 0).toLocaleString(), icon: TrendingUp, color: '#3b82f6', trend: null },
    ...
    'production-optimizer': [
      ...
      { label: 'Avg Efficiency', value: Math.round(data.reduce((sum, row) => sum + (row.efficiency || 0), 0) / data.length) + '%', icon: CheckCircle, color: '#3b82f6', trend: '+2%' },
    ...
    'mrp-accelerator': [
      ...
      { label: 'Total Quantity', value: data.reduce((sum, row) => sum + (row.quantity || 0), 0).toLocaleString(), icon: Inventory, color: '#3b82f6', trend: null },
    ],
    'bom-analyzer': [
      ...
      { label: 'Component Req', value: data.reduce((sum, row) => sum + (row.component_req || 0), 0).toLocaleString(), icon: TrendingUp, color: '#3b82f6', trend: null },
    ...
    'component-tracker': [
      ...
      { label: 'On Hand', value: data.reduce((sum, row) => sum + (row.on_hand || 0), 0).toLocaleString(), icon: CheckCircle, color: '#3b82f6', trend: null },
    ...
    'bom-exceptions': [
      ...
      { label: 'Low Severity', value: data.filter(r => r.severity === 'Low').length, icon: CheckCircle, color: '#3b82f6', trend: null },
    ],
    'consolidation-engine': [
      ...
      { label: 'Purchase Qty', value: data.reduce((sum, row) => sum + (row.purchase_qty || 0), 0).toLocaleString(), icon: TrendingUp, color: '#3b82f6', trend: null },
    ...
    'procurement-dashboard': [
      ...
      { label: 'Total Savings', value: '$' + data.reduce((sum, row) => sum + (row.savings || 0), 0).toLocaleString(), icon: TrendingUp, color: '#3b82f6', trend: '+18%' },
    ...
    'supplier-portal': [
      ...
      { label: 'Avg Delivery', value: Math.round(data.reduce((sum, row) => sum + (row.delivery_performance || 0), 0) / data.length) + '%', icon: TrendingUp, color: '#3b82f6', trend: '+2%' },
    ...
    'scenario-planner': [
      ...
      { label: 'Likely Demand', value: data.filter(r => r.scenario === 'Likely').reduce((sum, row) => sum + (row.forecasted_demand || 0), 0), icon: ShowChart, color: '#3b82f6', trend: 'Baseline' },
    ...
    'kpi-dashboard': [
      ...
      { label: 'Meets Target', value: data.filter(r => r.status === 'Meets').length, icon: CheckCircle, color: '#3b82f6', trend: 'Good' },
    ...
    'predictive-analytics': [
      ...
      { label: 'Avg Variance', value: '55%', icon: ShowChart, color: '#3b82f6', trend: 'High' },
    ],
    'working-capital-optimizer': [
      { label: 'Total Inventory Value', value: '$' + data.reduce((sum, row) => sum + (row.inventory_value || 0), 0).toLocaleString(), icon: AttachMoney, color: '#06b6d4', trend: null },
      { label: 'Optimal SKUs', value: data.filter(r => r.status === 'Optimal').length, icon: CheckCircle, color: '#10b981', trend: null },
